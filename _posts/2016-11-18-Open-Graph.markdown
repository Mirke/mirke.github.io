...
I had a hard time getting it to run on my site, however finally (rather ugly) but it does have the title, url , type and image. I'm happy just getting it to work, however, I will update it on a later date.
